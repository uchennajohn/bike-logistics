import { StyleSheet, Text,Image, View, Dimensions, TouchableOpacity, TouchableOpacityBase } from "react-native";
...
const RequestScreen = ({navigation}) => {
  const {dispatchOrigin, origin} = useContext(OriginContext)
      ...
      <View style={styles.view2}>
              ...
              <View style={styles.view4}>
                  <View>
                      <Image
                         style={styles.image1}
                         source={require("../../app/assets/transit.png")}
                      />
                  </View>
                  ...
                  <View>
                    <TouchableOpacity onPress={()=>{navigation.navigate("Destination")}}>
                        <View style={styles.view6}>
                              <Text style={styles.text1}>Enter pickup location </Text>
                        </View>
                    </TouchableOpacity>
                    <View style={styles.view7}>
                    <TouchableOpacity>
                        <View style={styles.view5}>
                          <Text style={styles.text10}>Where to?</Text>
                        </View>
                    </TouchableOpacity>
